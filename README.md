...
```
wget -q https://github.com/rhyeal/aws-rotate-iam-keys/blob/master/aws-rotate-iam-keys_0.7.0.deb -o aws-rotate-iam-keys.deb
...
### Linux
```
echo 8bce994cb2f5b575f0d72680e8c1dc94 aws-rotate-iam-keys.0.7.0.deb | md5sum --check -
```
### MacOS
