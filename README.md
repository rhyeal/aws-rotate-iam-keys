...
```
wget -q https://github.com/rhyeal/aws-rotate-iam-keys/blob/master/aws-rotate-iam-keys_0.6.deb -o aws-rotate-iam-keys.deb
...
### Linux
```
echo 0f0cba8d5c09b2e0ed10a2e137e16635 aws-rotate-iam-keys.0.6.deb | md5sum --check -
```
### MacOS
