...
```
wget -q https://github.com/rhyeal/aws-rotate-iam-keys/blob/master/aws-rotate-iam-keys_0.4.1.deb -o aws-rotate-iam-keys.deb
...
### Linux
```
echo 0b3b7b29864d7d16f0be6c5b1db4d0b5 aws-rotate-iam-keys.0.4.1.deb | md5sum --check -
```
### MacOS

Homebrew gets the release zip of the entire repo: `SHA256 5758b540b1c574f146ee4c2ed781bab258afd252c78e24e24a20f0594463e12b`
