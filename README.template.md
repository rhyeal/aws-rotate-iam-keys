...
```
wget -q https://github.com/rhyeal/aws-rotate-iam-keys/raw/master/aws-rotate-iam-keys.${VERSION}.deb -O aws-rotate-iam-keys.deb
...
Homebrew gets the release zip of the entire repo: `SHA256 ${HOMEBREW_SHA}`
